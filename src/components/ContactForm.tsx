...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // AUTO REPLY (user ko thank-you mail jayegi)
      // await emailjs.send(
      //   'service_mqxce34',
      //   'template_4twnb7c',
      //   {
  ...
  return (
    <section
      id="contact"
      className="py-24 relative overflow-hidden bg-[#050816] border-b border-white/5"
    >
          ...
          <div className="lg:col-span-5 space-y-10 text-center lg:text-left flex flex-col items-center lg:items-start reveal-fade-left">
            ...
            <div className="space-y-4 flex flex-col items-center lg:items-start">
              ...
              <p className="text-sm md:text-base text-slate-400 font-light leading-relaxed max-w-sm text-center lg:text-left">
                ...
                and our engineering team will get back to you within 24 hours.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left space-y-2 sm:space-y-0 sm:space-x-4 group/item">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <a
                    ...
                    className="text-sm font-semibold text-white hover:text-purple-400 transition-colors mt-0.5 block text-center sm:text-left"
                  >
                    +91 6396566630 <br />
                    +91 7055953578 <br />
                    +91 8006835201
